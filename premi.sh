...
echo -e "  Auther : ${green}ZEAKING22® ${NC}${YELLOW}(${NC} ${green} FreeTunnelProject${NC}${YELLOW})${NC}"
echo -e " © Recode By FREE TUNNELING PROJECT${YELLOW}(${NC} 2023-2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
echo -e "   '----------------------------------'"
echo -e "     \e[1;32m1)\e[0m PAKAI DOMAIN PRIBADI"
